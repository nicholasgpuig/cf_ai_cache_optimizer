...
Format your responses using markdown for better readability when necessary. Use headings, lists, bold, and emphasis where appropriate to organize information clearly.`;
